...
#define MAX_CACHED_DIR_SLOTS_SIZE  10485760 //1MB= 1048576    here is 10MB, 20MB is 2097152
#define MAX_CACHED_ENTRIES_SIZE  10485760 //1MB= 1048576=131072 numbers of entries    here is 10MB, 20MB is 2097152
...
struct request {
    ...
    int if_need_movement_between_com_and_uncom_flag_and_page_numbers;// 0 means no page, other number means the real number of pages.
